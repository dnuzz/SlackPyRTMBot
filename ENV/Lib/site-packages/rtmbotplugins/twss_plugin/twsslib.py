...
import os
import sys
import nltk.PositiveNaiveBayesClassifier
import pickle
import datetime
...
class TWSSlib 
    ...
    def import_training_data(self,
        ...
        self.positive_training_data = map(features, positive_corpus)
        self.negative_training_data = map(features, negative_corpus)
    ...
    def train(self) 
        ...
        self.classifier = PositiveNaiveBayesClassifier.train(training_feature_set)
