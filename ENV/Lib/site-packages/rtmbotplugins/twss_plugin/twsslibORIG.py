...
class TWSSlib:
    ...
    def import_training_data(self,
        ...
        # self.positive_training_data = [line.rstrip('\n') for line in positive_corpus]
        # self.negative_training_data = [line.rstrip('\n') for line in negative_corpus]

        for line in positive_corpus:
            self.positive_training_data.append(line)

        print(len(self.positive_training_data))
    ...
    def train(self):
        ...
        for line in self.positive_training_data:
            positive_training.append(self.features(line))

        negative_training = []#list(map(self.features(), self.negative_training_data))
        for line in self.negative_training_data:
            negative_training.append(self.features(line))

        self.classifier = NaiveBayesClassifier.train(positive_training)
